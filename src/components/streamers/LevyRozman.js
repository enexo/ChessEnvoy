...
function LevyRozman() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const user = await api.get('https://api.twitch.tv/helix/users?login=gothamchess');
            ...
            const channel = await api.get('https://api.twitch.tv/helix/search/channels?query=gothamchess');
            let channelResult = channel.data.data[0].is_live;
            const isLive = "Levy Rozman is Live on Twitch!";
            ...
            <div className="container">
                <div className="row">
                    <div className="col">
                        ...
                        <div className="row">
                            <div className="col">
                                <strong><a href="https://en.wikipedia.org/wiki/FIDE">FIDE Rating</a>: 2343</strong>
                            </div>
                        </div>
                        <br/>
                        <div className="row">
                        ...
                        <div className="row">
                            <div className="col socialLinks">
                                ...
                                <a href="https://www.twitch.tv/gothamchess" className="socialLinks">Twitch</a>
                            </div>
                            <div className="col socialLinks">
                                <FontAwesomeIcon icon={["fab", "twitter"]} className="social twitter"/>
                                <a href="https://twitter.com/gothamchess" className="socialLinks">Twitter</a>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col">
                                <FontAwesomeIcon icon={["fab", "youtube"]} className="social youtube"/>
                                <a href="https://www.youtube.com/channel/UCQHX6ViZmPsWiYSFAyS0a3Q" className="socialLinks">Youtube</a>
                            </div>
                            <div className="col">
                                <FontAwesomeIcon icon={faPen} className="social pen"/>
                                <a href="https://gotham-chess.com" className="socialLinks">Personal Site</a>
                            </div>
                        </div>
                        <br/>
                        <div className="row">
